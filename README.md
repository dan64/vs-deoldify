...
,  [DDColor](https://github.com/HolyWu/vs-ddcolor), [Colorization](https://github.com/richzhang/colorization), [Deep Exemplar based Video Colorization](https://github.com/zhangmozhe/Deep-Exemplar-based-Video-Colorization) and [ColorMNet](https://github.com/yyang181/colormnet). The project  [Colorization](https://github.com/richzhang/colorization) includes 2 models: _Colorful Image Colorization_ (Zhang, 2016) and _Real-Time User-Guided Image Colorization with Learned Deep Priors_ (Zhang, 2017), these 2 models has been added as additonal models: eccv16,  siggraph17 in DDColor .
